...
public class GravesLSTMCharModellingWeatherForecasts {
	public static void main( String[] args ) throws Exception {
		...
		/*
		######## LAB STEP 1 #############
		Uncomment the following block of code and fill in the needed
		...
		/*
		######## LAB STEP 2 #############
		Add 3 layers as described in the Lab manual
		...
		/*
		######### LAB STEP 3 ###########
		CONFIGURE THE BACKPROPAGATION SETTINGS
		 */
		...
		/*
		########## LAB STEP 4 ###########
		Create a network from the configuration
		Initialize the network
		attach a Listener so you can view progress on the console output
